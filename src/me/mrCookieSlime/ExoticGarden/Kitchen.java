...
public class Kitchen extends MultiBlockMachine {
	...
	public Kitchen(ExoticGarden plugin) {
		super(
			Categories.MACHINES_1, new SlimefunItemStack("KITCHEN", Material.CAULDRON, "&eКухня", "", "&a&oДля приготовления всяких вкусняшек!", "&a&oРезультат появляется в печке."), "KITCHEN",
